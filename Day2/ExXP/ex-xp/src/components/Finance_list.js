    ...
    return (
      <div>
        {financeArr.map((pay, i) => {
          return (
            <div key={i}>
              <span style={{ border: "2px solid black" }}>{pay.account}</span>
              <span style={{ border: "2px solid black" }}>{pay.fsc}</span>
              <span style={{ border: "2px solid black" }}>{pay.holder}</span>
              <span style={{ border: "2px solid black" }}>{pay.amount}</span>
